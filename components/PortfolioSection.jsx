...
const ProjectCard = ({ project, index, isMobile }) => {
  ...
  return (
    ...
    >
      {/* Image Side */}
      <div 
        className={`relative w-full aspect-[16/10] overflow-hidden rounded-[20px] border border-white/[0.06] ${
      ...
      >
        <Image
          ...
          alt={project.title}
          fill
          className="object-cover saturate-0 opacity-80 group-hover:saturate-100 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 ease-out"
          sizes="(max-width: 768px) 100vw, 60vw"
        />
        
        {/* Overlay on Hover */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#05000A]/80 via-[#05000A]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
        <div className="absolute bottom-6 left-6 font-inter text-[0.9rem] font-medium text-white translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100 z-10">
          View Case Study →
        </div>
      </div>
  ...
  const projects = [
    {
      ...
      img: "/public/portfolio/Something Undefined.svg"
    },
    {
      ...
      img: "/public/portfolio/Creative AI Collaboration.svg"
    },
    {
      title: "Neon Campaign",
      ...
      img: "/public/portfolio/Digital Marketing.svg"
    }
  ];
    ...
    <div className="w-full bg-[#05000A] py-[clamp(80px,12vw,160px)]">
      ...
      <div className="w-full max-w-[1200px] mx-auto px-[clamp(24px,5vw,80px)] mb-16">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[#5E17EB] uppercase font-inter text-[0.8rem] font-medium tracking-[0.15em]">SELECTED WORK</span>
        </div>
        <h2 className="heading-section mt-4 text-white">Our Work</h2>
