      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-[64px]">
        ...
        <div className="flex flex-col justify-start items-start">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#5E17EB] uppercase font-inter text-[0.8rem] font-medium tracking-[0.15em]">GET IN TOUCH</span>
          </div>
          <h2 className="heading-section mt-4">Let's Start a Conversation</h2>
